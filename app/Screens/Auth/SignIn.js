  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      <ScrollView contentContainerStyle={{ flexGrow: 1 }} keyboardShouldPersistTaps="handled">
        <View style={{ ...GlobalStyleSheet.container, flex: 1, paddingVertical: 20, backgroundColor: colors.background }}>
          ...
          <View style={{ marginBottom: 30, alignItems: 'center' }}>
            ...
            <Text style={{ ...FONTS.font, color: colors.text, textAlign: 'center', maxWidth: '80%' }}>
          ...
          <View style={GlobalStyleSheet.inputGroup}>
            ...
            />
            {errors.email && (
              <Text style={{ color: COLORS.danger, ...FONTS.fontXs, marginTop: 4 }}>
                {errors.email}
              </Text>
            )}
          </View>
          ...
          <View style={[GlobalStyleSheet.inputGroup, { marginBottom: 10 }]}>
            ...
            <View style={{ position: 'relative' }}>
              ...
              <TouchableOpacity onPress={() => setShowPassword(!showPassword)} style={{ position: 'absolute', right: 15, top: 15 }}>
                <FeatherIcon name={showPassword ? 'eye-off' : 'eye'} color={colors.textLight} size={18} />
              </TouchableOpacity>
            </View>
            {errors.password && (
              <Text style={{ color: COLORS.danger, ...FONTS.fontXs, marginTop: 4 }}>
          ...
          <View style={{ marginTop: 20 }}>
            ...
            />
            {loading && <ActivityIndicator color={COLORS.primary} style={{ marginTop: 15 }} />}
          </View>
          ...
          <View style={{ marginTop: 30 }}>
            <Text style={{ ...FONTS.font, color: colors.text, textAlign: 'center', marginBottom: 15 }}>
