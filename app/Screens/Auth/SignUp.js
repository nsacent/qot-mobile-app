            ...
            >
                <View style={{ ...GlobalStyleSheet.container, flex: 1, backgroundColor: colors.background }}>
                    ...
                    >
                        ...
                        />
                        {errors.name && <Text style={{ color: COLORS.danger, ...FONTS.fontXs }}>{errors.name}</Text>}
                    </View>
                    ...
                    >
                        ...
                        <TextInput
                            ...
                            placeholderTextColor={colors.textLight}
                        />
                        {errors.email && <Text style={{ color: COLORS.danger, ...FONTS.fontXs }}>{errors.email}</Text>}
                    </View>
                    ...
                    >
                        ...
                        {errors.password && <Text style={{ color: COLORS.danger, ...FONTS.fontXs }}>{errors.password}</Text>}
                    </View>
                    ...
                    >
                        ...
                        {errors.confirmPassword && <Text style={{ color: COLORS.danger, ...FONTS.fontXs }}>{errors.confirmPassword}</Text>}
                    </View>
                    ...
                    >
                        ...
                        />
                        {errors.terms && <Text style={{ color: COLORS.danger, ...FONTS.fontXs }}>{errors.terms}</Text>}
                    </View>
