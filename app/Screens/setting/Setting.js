                ...
                {SettingData.map((data, index) => (
                    ...
                    >
                        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                            <Image
                                style={{ width: 22, height: 22, resizeMode: 'contain', tintColor: data.title === 'Logout' ? COLORS.danger : colors.title  }}
                                source={data.image}
                            />
                            <View style={{ marginLeft: 10 }}>
                                <Text style={{ ...FONTS.fontSm, ...FONTS.fontMedium, fontSize: 15, color: data.title === 'Logout' ? COLORS.danger : colors.title }}>
                                    {data.title}
                                </Text>
                            </View>
                        </View>
            ...
            <Modal
                ...
                <View style={{
                    ...
                    <View style={{ alignItems: 'center', justifyContent: 'center', marginBottom: 15, marginTop: 10 }}>
                        <View style={{ height: 80, width: 80, opacity: 0.2, backgroundColor: COLORS.warning, borderRadius: 80 }} />
                        <View style={{
                            height: 65,
                            width: 65,
                    ...
                    <Text style={{ ...FONTS.h4, color: colors.title, marginBottom: 8 }}>Confirm Logout</Text>
